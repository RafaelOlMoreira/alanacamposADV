...
function Contato() {
    ...
    return (
        ...
        // dourado: #c9a87c
        <>
            <section className='h-auto bg-gray-50 font-inter px-8 mt-6 pt-15 pb-10 text-center'>
                ...
                <button className='mt-8 bg-[#1a3b5d] w-full text-white p-4 rounded-lg text-sm'>Enviar Mensagem</button>
            </section>
        </>
    )
}
