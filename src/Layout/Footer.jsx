...
function Footer() {
    ...
    // dourado: #c9a87c
    return (
        <footer className='h-auto bg-[#1a3b5d] font-inter px-8 mt-6 pt-15 pb-10'>

            <div>
                <div className='space-y-5'>
                    <img src="#" />
                    <p className='text-gray-300 text-sm leading-relaxed'>Advocacia com excelência, ética e dedicação. Soluções jurídicas personalizadas para proteger seus direitos e interesses.</p>
                </div>
                <div className='mt-5 text-white'>
                    <h6 className='pb-3'>Contato</h6>
                ...
                <div className='mt-5 text-white'>
                    <h6 className='pb-3'>Redes Sociais</h6>

                    <div className='flex space-x-3'>
                        {dataRS.map((e) => (
                            <button className='p-2 border-2 border-white rounded-full hover:border-[#c9a87c] hover:bg-[#c9a87c] transition-all duration-300'>
                                <a href={e.linkRS}>
                                    {e.iconRS}
                                </a>
                            </button>
            ...
            <p className='text-gray-300 text-sm py-3 text-center'>&copy; Dra. Ana Carolina Silva - Advocacia. Todos os direitos reservados. OAB/SP 123.456</p>
...
const dataRS = [
    {
        ...
        iconRS: <FaInstagram className='size-5' />,
    },
    {
        linkRS: `https://github.com/RafaelOlMoreira`,
        iconRS: <FaFacebook className='size-5' />,
    },
]